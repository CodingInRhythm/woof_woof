					...
					<Animator animation={SlideUp}>
						<div className="splash_main-1 splash_page">
							<h1 className="splash_main-1-text">
								Here is an amazing
								<span className="splash_main-1-text-highlight"> Slack clone</span>! Want to check it
								out?
							</h1>
							<Link to="/sign-up">
								<div className="splash_tryout_btn">Try for free</div>
							</Link>
					...
					<Animator animation={SlideUp}>
						<div className="splash_main-2 splash_page">
							<div className="splash_main-2-left">
								...
								<br />
								<h4>
									This project combines the power of a React frontend to dynamically display content
									with a Python backend to serve data and host websockets
								</h4>
							</div>
							<div className="splash_main-2-right">
								<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" id="js_logo">
								...
								<a href="https://flask.palletsprojects.com/en/2.0.x/" id="flask_logo">
									<img src={flask} className="splash-logo" alt="flask-logo" />
								</a>
								<a href="https://www.postgresql.org/" id="postgres_logo">
									<img src={postgres} className="splash-logo" alt="postgres-logo" />
								</a>
							</div>
						</div>
					</Animator>
